...
export function AdminSettingsView() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="glass-card rounded-xl p-3 space-y-2">
        <h3 className="text-sm font-semibold">Daily Check-in Rewards (Days 1-7)</h3>
        ...
        <Button size="sm" className="w-full h-8 text-xs" onClick={() => save("checkin_rewards", { days: checkinDays }, "Check-in")}>
