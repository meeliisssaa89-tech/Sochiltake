import { motion } from "framer-motion";
  import { Home, ListChecks, Activity, User } from "lucide-react";
  ...
  const tabs = [
    { id: "home",     icon: Home,       labelKey: "home",     iconKey: "nav_home"     },
    { id: "tasks",    icon: ListChecks, labelKey: "tasks",    iconKey: "nav_tasks"    },
    { id: "activity", icon: Activity,   labelKey: "activity", iconKey: "nav_activity" },
    { id: "profile",  icon: User,       labelKey: "profile",  iconKey: "nav_profile"  },
  ] as const;
